...
public class AlbumActivity extends Activity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv1 = (ImageView)findViewById(R.id.iv_album_1);
        iv2 = (ImageView)findViewById(R.id.iv_album_2);
        iv3 = (ImageView)findViewById(R.id.iv_album_3);
...
//                    System.out.println("y="+event.values[1]);
                ...
                if(flag>=3&&flag<4&&SystemClock.elapsedRealtime()-curtime1>500){
                    ...
                    if(num==1){
                        ...
                        intent.setClass(AlbumActivity.this, AlbumNextActivity.class);
    ...
    private void downLineChange(int Num){
        switch (Num){
            case 1:
                iv2.setImageResource(R.drawable.erhover);
                iv1.setImageResource(R.drawable.yi);
                num=2;
                break;
            case 2:
                iv3.setImageResource(R.drawable.sanhover);
                iv2.setImageResource(R.drawable.er);
                num=3;
                break;
            case 3:
                iv1.setImageResource(R.drawable.yihover);
                iv3.setImageResource(R.drawable.san);
                num=1;
                break;
        }
    }

    private void upLineChange(int Num){
        switch (Num){
            case 1:
                iv3.setImageResource(R.drawable.sanhover);
                iv1.setImageResource(R.drawable.yi);
